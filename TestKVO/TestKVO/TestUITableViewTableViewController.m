//
//  TestUITableViewTableViewController.m
//  TestKVO
//
...
#import "TestCell.h"
@interface TestUITableViewTableViewController ()

@end

@implementation TestUITableViewTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(!cell)
    {
        ...
        NSLog(@"nib row : %ld",indexPath.row);
    }
    
    // Configure the cell...
    cell.testField.tag = indexPath.row;
    cell.testField.text = [NSString stringWithFormat:@"%ld",indexPath.row];
